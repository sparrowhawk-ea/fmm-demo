...
declare class EaReactive extends Ea {
    constructor();
...
declare class EaState extends Ea {
...
interface Earthsea extends FmmStoreValues {
    adventure: string;
    adventure2: string;
...
export { Ea, EaReactive, EaState, Earthsea };
